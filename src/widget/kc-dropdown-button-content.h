...
extern const char *kc_dropdown_button_content_get_label_text (KcDropDownButtonContent *self);
extern void kc_dropdown_button_content_set_label_text (KcDropDownButtonContent *self, const gchar *label_text);
