...
public class Application : Gtk.Application {
    ...
    public static string COLOR_SCHEME_DEFAULT = "default"; // vala-lint=naming-convention
    public static string COLOR_SCHEME_FORCE_LIGHT = "force-light"; // vala-lint=naming-convention
    public static string COLOR_SCHEME_FORCE_DARK = "force-dark"; // vala-lint=naming-convention
